...
public class ClientHttpRequest {
	 ...
	 * @throws IOException
	 */
	public ClientHttpRequest(URLConnection connection, int timeout) throws IOException {
		this(connection);
	 ...
	 * @throws IOException
	 */
	public ClientHttpRequest(URL url, int timeout) throws IOException {
		this(url.openConnection());
		this._connection.setConnectTimeout(timeout);
	}
	...
	private int pipe(InputStream in) throws IOException {
